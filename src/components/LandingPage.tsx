...
export function LandingPage({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 py-8" style={customStyle}>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden mb-8">
        ...
        <div className="px-6 pb-6 relative">
          ...
          <div className="pt-20 md:pt-28">
            <div className="mb-4">
              <h1 className="text-xl sm:text-2xl font-bold text-slate-900 text-left leading-tight whitespace-nowrap mb-1">
                {finalProfile.name}
              </h1>
      ...
      <Footer profileData={finalProfile} setActiveTab={setActiveTab} showIgrejasTab={isLoggedIn || showIgrejasTab} />
