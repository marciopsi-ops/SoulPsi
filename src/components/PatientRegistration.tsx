          ...
          <form onSubmit={handleSubmit} className="p-8">
             ...
             <div className="space-y-4 mb-8 bg-slate-50 p-6 rounded-2xl border border-slate-100">
                ...
                <label className="flex items-start gap-3 cursor-pointer group">
                   ...
                   <div className="text-sm text-slate-600 leading-relaxed">
                      <strong>Contrato Terapeuta-Paciente (Ciente das Regras):</strong> Declaro estar ciente e de acordo com as regras de funcionamento das sessões (presenciais ou online), incluindo valores, formas de pagamento, e a política de cancelamentos (avisos necessários com antecedência mínima negociada), garantindo o compromisso bilateral durante todo o processo terapêutico.
                   </div>
                </label>
             </div>
